...
{/* Desktop Background Image */}
  ...
  >
    <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row gap-6 lg:gap-10 relative py-16 lg:py-32 top-[600px] md:top-[350px] ">
      {/* Left Card: Let’s Connect */}
      <div className="bg-[#181D24] text-white p-8 lg:p-12 rounded-tr-[40px] lg:rounded-tr-[80px] w-full lg:w-[470px] flex flex-col items-center text-center shadow-lg">
        <h2
          className="font-bold mb-6 text-[28px] md:text-[36px] lg:text-[52px]"
          style={{
            fontFamily: "Rufina",
            color: "#F5E9D6",
            lineHeight: "1.2",
        ...
        <div className="grid grid-cols-2 gap-y-4 w-full max-w-[336px] text-left text-[13px] md:text-[15px] lg:text-[16px]">
...
<div className="block md:hidden relative">
  ...
  {/* Background color section with content floating halfway over image */}
