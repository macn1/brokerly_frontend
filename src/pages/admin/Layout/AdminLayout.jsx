...
const AdminLayout = () => {
  ...
  const allMenuItems = [
    ...
    {
      icon: <GetIcon iconName="MdHomeRepairService" />,
      label: "Apartment Extra Services",
      to: "/admin/extra-service",
    },

    {
      icon: <GetIcon iconName="FaUserFriends" />,
      label: "Contacted Customers",
      to: "/admin/contacted-customers",
    },
        ...
        <div className="flex">
          ...
          >
            <div className="flex flex-col h-full">
              ...
              <Menu className="flex-grow overflow-y-auto" menuItemStyles={{
                button: {
                  '&:hover': {
